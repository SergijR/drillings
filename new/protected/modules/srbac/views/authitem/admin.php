 ...
 */
 ?>
<h2><?php echo t('Managing AuthItem')?></h2>

<div class="actionBar">
[<?php echo SHtml::link(t('AuthItem List'),array('list')); ?>]
[<?php echo SHtml::link(t('New AuthItem'),array('create')); ?>]
</div>
...
<?php foreach($models as $n=>$model): ?>
  <tr class="<?php echo $n%2?'even':'odd';?>">
    ...
    <td>
      <?php echo SHtml::link(t('Update'),array('update','id'=>$model->name)); ?>
      <?php if ($model->name !=  Yii::app()->getModule('srbac')->superUser) { ?>
      <?php echo SHtml::linkButton(t('Delete'),array(
          'submit'=>'',
