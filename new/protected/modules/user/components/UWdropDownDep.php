...
class UWdropDownDep {
	...
	public function init() {
		return array(
			'name'=>__CLASS__,
			'label'=>t('DropDown List Dependent',array(),__CLASS__),
			'fieldType'=>array('INTEGER'),
			'params'=>$this->params,
			'paramsLabels' => array(
				'modelName'=>t('Model Name',array(),__CLASS__),
				'optionName'=>t('Lable field name',array(),__CLASS__),
				'emptyField'=>t('Empty item name',array(),__CLASS__),
				'relationName'=>t('Profile model relation name',array(),__CLASS__),
				'modelDestName'=>t('Model Dest Name',array(),__CLASS__),
				'destField'=>t('Dest Field',array(),__CLASS__),
				'optionDestName'=>t('Label Dest field name',array(),__CLASS__),
			),
		);
	}
