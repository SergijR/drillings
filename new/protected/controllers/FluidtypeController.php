...
class FluidtypeController extends Controller
{
	/**
	...
	{
		$dataProvider=new CActiveDataProvider('FluidType');
	 ...
	 * @return FluidType the loaded model
	 ...
	 * @param FluidType $model the model to be validated
	 */
