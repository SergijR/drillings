...
class ArchController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('Arch');
	...
	{
		$model=new Arch('search');
		$model->unsetAttributes();  // clear any default values
		if (isset($_GET['Arch'])) {
			$model->attributes=$_GET['Arch'];
		}
	 ...
	 * @return Arch the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Arch::model()->findByPk($id);
		if ($model===null) {
	 ...
	 * @param Arch $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if (isset($_POST['ajax']) && $_POST['ajax']==='arch-form') {
