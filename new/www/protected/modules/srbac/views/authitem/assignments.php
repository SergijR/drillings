...
if (!$id) {
  ...
  <div class="simple">
    ...
    <?php
    echo t( 'User') . ": " . SHtml::activeDropDownList($this->module->getUserModel(), $this->module->userid, SHtml::listData($this->module->getUserModel()->findAll(), $this->module->userid, $this->module->username), array('disabled'=>'disabled', 'size' => 1, 'class' => 'dropdown', 'ajax' => array(
            'type' => 'POST',
